...
`;const oe={parse:function(e,t){if(!e)return null;const n=/([^=?&]+)=?([^&]*)/g,a={};let r;for(;r=n.exec(e);){const e=ie(r[1]);let n=ie(r[2]);null===e||null===n||e in a||(t||(n=isNaN(Number(n))?n:Number(n)),a[e]=n)}return a},stringify:function(e,t=""){const n=[];let a,r;for(r in"string"!=typeof t&&(t="?"),e)if(Object.prototype.hasOwnProperty.call(e,r)){if(a=e[r],a||null!=a&&!isNaN(a)||(a=""),r=encodeURIComponent(r),a=encodeURIComponent(a),null===r||null===a)continue;n.push(`${r}=${a}`)}return n.length?t+n.join("&"):""},decode:ie},se=[];function le(e){const t=document.createElement("span");return t.style.display="none",t.setAttribute("aoife-route",e),t}["popstate","pushState","replaceState"].forEach((e=>{window.addEventListener(e,(()=>{de.state=oe.parse(location.search),se.forEach((e=>e()))}))}));let ue=0;const de=({root:e,url:t,render:n,preload:a})=>{if("function"!=typeof n)throw"AoifeRoute.render need a Function";ue+=1;const r=""+ue,i=()=>{if(a&&n(),"function"==typeof t){if(!t())return le(r)}else{let n=!1;if(e&&"/"===window.location.pathname&&(n=!0),!n&&oe.decode(window.location.pathname)!==t)return le(r)}const i=n();if(i.then){const e=le(r);return Promise.resolve(i).then((e=>{if(e.default){const t=document.querySelector(`[aoife-route="${r}"]`);if(!t)return;const n=e.default();n.setAttribute("aoife-route",r),t.replaceWith(n)}})),e}return i.setAttribute("aoife-route",r),i};return se.push((()=>{const e=document.querySelector(`[aoife-route="${r}"]`);e&&e.replaceWith(i())})),i()};de.state={},de.queryString=oe,de.push=(e,t,n)=>{t&&(e+="?"+oe.stringify(t)),n||window.scrollTo&&window.scrollTo({top:0}),setTimeout((()=>{history.pushState(t,"",e),window.dispatchEvent(new Event("pushState"))}))},de.replace=(e,t,n)=>{t&&(e+="?"+oe.stringify(t)),n||window.scrollTo&&window.scrollTo({top:0}),setTimeout((()=>{history.replaceState(t,"",e),window.dispatchEvent(new Event("replaceState"))}))},de.back=()=>{history.back()};const ce=(e,t)=>{e.showMobileMenu=t,aoife.next(".aoife-markdown-page .mobile-menu")},pe=(e,t,n)=>{t.showMobileMenu=!1,t.num=n,aoife.next("*"),de.push(e)},ge=({state:e,title:t,version:n,data:a,homepage:r})=>aoife("div",{class:"menu"},aoife("div",{class:["menu-title",r&&"menu-have-home-page"],onclick:()=>{r&&window.open(r)}},t||"Aofie Document"),n&&aoife("div",{class:"menu-version"},n),aoife("div",{class:"menu-items"},a.map(((t,n)=>aoife("div",{class:()=>[e.num===n&&"menu-item-selected","menu-item"],onclick:()=>{pe("/"+t.name,e,n)}},t.name)))),aoife("div",{class:"menu-footer",onclick:()=>window.open("https://github.com/ymzuiku/aoife-doc")},"Powered by ",aoife("span",{class:"by-aoife-doc"},"Aoife-doc")));W`
...
`;const me=({title:e,version:t,state:n,markdownState:a,data:r,homepage:i})=>aoife("div",{class:()=>["header js-aoife-markdown-header",a.isScrollDown&&"header-shadow"]},aoife("div",{class:"header-icon",innerHTML:'<svg t="1614770422406" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2063" width="1em" height="1em"><path d="M109.714 292.571h804.572c21.943 0 36.571-21.942 36.571-43.885 0-14.629-14.628-29.257-36.571-29.257H109.714c-21.943 0-36.571 14.628-36.571 36.571 0 14.629 14.628 36.571 36.571 36.571zM914.286 512H109.714c-21.943 0-36.571 14.629-36.571 36.571 0 14.629 14.628 36.572 36.571 36.572h804.572c21.943 0 36.571-21.943 36.571-43.886 0-14.628-14.628-29.257-36.571-29.257z m0 292.571H109.714c-21.943 0-36.571 14.629-36.571 36.572s14.628 36.571 36.571 36.571h804.572c21.943 0 36.571-21.943 36.571-36.571 0-21.943-14.628-36.572-36.571-36.572z" p-id="2064"></path></svg>',onclick:()=>{ce(n,!0)}}),aoife("span",{class:"header-info",onclick:()=>{window.scrollTo({top:0,behavior:"auto"})}},(()=>n&&r&&r[n.num]&&r[n.num].name)),aoife("span",null),aoife("label",{class:["header-title",i&&"header-have-home-page"],onclick:()=>{i&&window.open(i)}},e||"Aofie Document"),aoife("div",{class:()=>["mobile-menu",n.showMobileMenu&&"mobile-show"]},aoife("div",{class:"mobile-plan"},aoife(ge,{version:t,title:e,data:r,state:n})),aoife("div",{class:"mobile-mask",onclick:()=>{ce(n,!1)}})));W`
...
`;const fe=()=>aoife("svg",{t:"1614958133927",class:"icon",viewBox:"0 0 1024 1024",version:"1.1",xmlns:"http://www.w3.org/2000/svg","p-id":"4404",width:"1.5em",height:"1.5em"},aoife("path",{d:"M866.92864 476.29312a35.84 35.84 0 1 1 0 71.68h-696.32a35.82976 35.82976 0 0 1-35.84-35.84c0-19.80416 16.03584-35.84 35.84-35.84h696.32z",fill:"currentColor","p-id":"4405"}),aoife("path",{d:"M221.2864 512.13312l213.59616-213.59616a35.84 35.84 0 0 0-50.67776-50.688l-238.9504 238.9504a35.84 35.84 0 0 0 0 50.67776l238.9504 238.9504a35.84 35.84 0 0 0 50.67776-50.688l-213.59616-213.6064z",fill:"currentColor","p-id":"4406"})),he=({state:e,data:t,num:n})=>{if(!t||t.length<2)return aoife("div",null);const a=n=>{pe("/"+t[n].name,e,n)},r=()=>{t[n-1]&&a(n-1)},i=()=>{t[n+1]&&a(n+1)};return n===t.length-1?aoife("div",{class:"aoife-markdown-page-btn"},aoife("div",{class:"btn left",onclick:r},aoife("div",{class:"arrow arrow-left"},aoife(fe,null)),aoife("div",{class:"title"},aoife("label",{class:"tip"},"Previous"),aoife("span",{class:"name"},t[n-1]&&t[n-1].name)))):0===n?aoife("div",{class:"aoife-markdown-page-btn"},aoife("div",{class:"btn right",onclick:i},aoife("div",{class:"title"},aoife("label",{class:"tip"},"Next"),aoife("span",{class:"name"},t[n+1].name)),aoife("div",{class:"arrow arrow-right"},aoife(fe,null)))):aoife("div",{class:"aoife-markdown-page-btn double"},aoife("div",{class:"btn left",onclick:r},aoife("div",{class:"arrow arrow-left"},aoife(fe,null)),aoife("div",{class:"title"},aoife("label",{class:"tip"},"Previous"),aoife("span",{class:"name"},t[n-1].name))),aoife("div",{class:"btn right",onclick:i},aoife("div",{class:"title"},aoife("label",{class:"tip"},"Next"),aoife("span",{class:"name"},t[n+1].name)),aoife("div",{class:"arrow arrow-right"},aoife(fe,null))))};function be(e){const t=function(){if(window.location.hash.length>1){const e=window.location.hash.replace("#/","");return decodeURI(e)}const e=window.location.pathname.replace("/","");return decodeURI(e)}();if(!t)return 0;let n=0;return e.forEach(((e,a)=>{e.name===t&&(n=a)})),n}W`
...
`;const De=({version:e,title:t,data:n,homepage:a})=>{const r={num:be(n),showMobileMenu:!1,showPcMenu:!0};return aoife("div",{class:"aoife-markdown-page"},aoife(me,{version:e,data:n,title:t,state:r,homepage:a,markdownState:ae}),aoife("div",{class:"content"},aoife("div",{class:"menu-box"},aoife(ge,{version:e,title:t,state:r,data:n,homepage:a})),aoife("div",{class:"aoife-markdown-page-md"},n.map(((e,t)=>aoife(de,{root:0===t,url:"/"+e.name,render:()=>aoife(re,{footer:aoife(he,{state:r,num:t,data:n}),text:n[t]&&n[t].text})}))))))};W`
...
`;const Ee=({url:e})=>{fetch(e+"?t="+Date.now()).then((e=>e.json())).then((e=>{const n=e.files.map((t=>(/\.md$/.test(t)||(t+=".md"),fetch(e.path+t+"?version="+e.version||"0.0.0").then((e=>e.text())))));Promise.all(n).then((n=>{const a=[];n.forEach(((t,n)=>{a.push({name:e.files[n],text:t})})),t.innerHTML="",e.list=a,t.replaceWith(aoife(De,i({data:a},e)))}))}));const t=aoife("div",{class:"aoife-markdown-loading"},"Loading...");return t};W`
...
`,K(window.aoifeMarkdownTheme||"gitbook"),window.MarkdownBook=Ee;export{Ee as M,ne as V,O as a,N as b,R as c,I as d,De as e,re as f,B as g,K as u};
