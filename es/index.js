...
`;const N=(e,t)=>{e.showMobileMenu=t,aoife.next(".aoife-markdown-page .mobile-menu")},L=(e,t,n)=>{t.showMobileMenu=!1,t.num=n,aoife.next("*"),I.push(e)},z=({state:e,title:t,version:n,data:r,homepage:a})=>aoife("div",{class:"menu"},aoife("div",{class:["menu-title",a&&"menu-have-home-page"],onclick:()=>{a&&window.open(a)}},t||"Aofie Document"),n&&aoife("div",{class:"menu-version"},n),aoife("div",{class:"menu-items"},r.map(((t,n)=>aoife("div",{class:()=>[e.num===n&&"menu-item-selected","menu-item"],onclick:()=>{L("/"+t.name,e,n)}},t.name)))),aoife("div",{class:"menu-footer",onclick:()=>window.open("https://github.com/ymzuiku/aoife-doc")},"Powered by ",aoife("span",{class:"by-aoife-doc"},"Aoife-doc")));E`
...
`;const P=({title:e,version:t,state:n,markdownState:r,data:a,homepage:i})=>aoife("div",{class:()=>["header js-aoife-markdown-header",r.isScrollDown&&"header-shadow"]},aoife("div",{class:"header-icon",innerHTML:'<svg t="1614770422406" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2063" width="1em" height="1em"><path d="M109.714 292.571h804.572c21.943 0 36.571-21.942 36.571-43.885 0-14.629-14.628-29.257-36.571-29.257H109.714c-21.943 0-36.571 14.628-36.571 36.571 0 14.629 14.628 36.571 36.571 36.571zM914.286 512H109.714c-21.943 0-36.571 14.629-36.571 36.571 0 14.629 14.628 36.572 36.571 36.572h804.572c21.943 0 36.571-21.943 36.571-43.886 0-14.628-14.628-29.257-36.571-29.257z m0 292.571H109.714c-21.943 0-36.571 14.629-36.571 36.572s14.628 36.571 36.571 36.571h804.572c21.943 0 36.571-21.943 36.571-36.571 0-21.943-14.628-36.572-36.571-36.572z" p-id="2064"></path></svg>',onclick:()=>{N(n,!0)}}),aoife("label",{class:["header-title",i&&"header-have-home-page"],onclick:()=>{i&&window.open(i)}},e||"Aofie Document"),aoife("span",null),aoife("span",{class:"header-info",onclick:()=>{window.scrollTo({top:0,behavior:"auto"})}},(()=>n&&a&&a[n.num]&&a[n.num].name)),aoife("span",{class:"header-arrow",onclick:()=>{window.scrollTo({top:0,behavior:"auto"})}},aoife("svg",{t:"1617685881508",class:"icon",viewBox:"0 0 1024 1024",version:"1.1",xmlns:"http://www.w3.org/2000/svg","p-id":"1921",width:"1em",height:"1em"},aoife("path",{d:"M329.745 562.745c-12.497 12.497-12.497 32.758 0 45.255 12.372 12.372 32.354 12.496 44.878 0.371L375 608l126.059-126.059c6.248-6.248 16.379-6.248 22.627 0L649.746 608c12.371 12.372 32.353 12.496 44.877 0.371L695 608c12.372-12.372 12.496-32.354 0.371-44.878l-0.371-0.377-137.373-137.372c-24.743-24.744-64.707-24.991-89.755-0.743l-0.754 0.743-137.373 137.372z","p-id":"1922"}))),aoife("div",{class:()=>["mobile-menu",n.showMobileMenu&&"mobile-show"]},aoife("div",{class:"mobile-plan"},aoife(z,{version:t,title:e,data:a,state:n,homepage:i})),aoife("div",{class:"mobile-mask",onclick:()=>{N(n,!1)}})));E`
...
`;const G=({version:e,title:t,data:n,homepage:r})=>{const a={num:j(n),showMobileMenu:!1,showPcMenu:!0};return aoife("div",{class:"aoife-markdown-page"},aoife(P,{version:e,data:n,title:t,state:a,homepage:r,markdownState:B}),aoife("div",{class:"content"},aoife("div",{class:"menu-box"},aoife(z,{version:e,title:t,state:a,data:n,homepage:r})),aoife("div",{class:"aoife-markdown-page-md"},n.map(((e,t)=>aoife(I,{root:0===t,url:"/"+e.name,render:()=>aoife(O,{footer:aoife(U,{state:a,num:t,data:n}),text:n[t]&&n[t].text})}))))))};E`
...
`;const H=({url:t})=>{fetch(t+"?t="+Date.now()).then((e=>e.json())).then((t=>{const r=t.files.map((e=>"object"==typeof e?fetch(e.url).then((e=>e.text())):(/\.md$/.test(e)||(e+=".md"),fetch(t.path+e+"?version="+t.version||"0.0.0").then((e=>e.text())))));Promise.all(r).then((r=>{const a=[];r.forEach(((e,n)=>{const r=t.files[n];"object"==typeof r?a.push({name:r.name,text:e}):a.push({name:t.files[n],text:e})})),n.innerHTML="",t.list=a,t.title&&(document.title=t.title),"/"===location.pathname&&a[0]&&I.push(a[0].name),n.replaceWith(aoife(G,e({data:a},t)))}))}));const n=aoife("div",{class:"aoife-markdown-loading"},"Loading...");return n};E`
...
`,w(window.aoifeMarkdownTheme||"gitbook"),window.MarkdownBook=H;export{H as M,C as V,a,i as b,t as c,n as d,G as e,O as f,r as g,w as u};
