...
`;const $={parse:function(e,t){if(!e)return null;const n=/([^=?&]+)=?([^&]*)/g,a={};let r;for(;r=n.exec(e);){const e=_(r[1]);let n=_(r[2]);null===e||null===n||e in a||(t||(n=isNaN(Number(n))?n:Number(n)),a[e]=n)}return a},stringify:function(e,t=""){const n=[];let a,r;for(r in"string"!=typeof t&&(t="?"),e)if(Object.prototype.hasOwnProperty.call(e,r)){if(a=e[r],a||null!=a&&!isNaN(a)||(a=""),r=encodeURIComponent(r),a=encodeURIComponent(a),null===r||null===a)continue;n.push(`${r}=${a}`)}return n.length?t+n.join("&"):""},decode:_},R=[];function I(e){const t=document.createElement("span");return t.style.display="none",t.setAttribute("aoife-route",e),t}["popstate","pushState","replaceState"].forEach((e=>{window.addEventListener(e,(()=>{O.state=$.parse(location.search),R.forEach((e=>e()))}))}));let B=0;const O=({root:e,url:t,render:n,preload:a})=>{if("function"!=typeof n)throw"AoifeRoute.render need a Function";B+=1;const r=""+B,i=()=>{if(a&&n(),"function"==typeof t){if(!t())return I(r)}else{let n=!1;if(e&&"/"===window.location.pathname&&(n=!0),!n&&$.decode(window.location.pathname)!==t)return I(r)}const i=n();if(i.then){const e=I(r);return Promise.resolve(i).then((e=>{if(e.default){const t=document.querySelector(`[aoife-route="${r}"]`);if(!t)return;const n=e.default();n.setAttribute("aoife-route",r),t.replaceWith(n)}})),e}return i.setAttribute("aoife-route",r),i};return R.push((()=>{const e=document.querySelector(`[aoife-route="${r}"]`);e&&e.replaceWith(i())})),i()};O.state={},O.queryString=$,O.push=(e,t,n)=>{t&&(e+="?"+$.stringify(t)),history.pushState(t,"",e),window.dispatchEvent(new Event("pushState")),n||document.documentElement.scrollTo({top:0})},O.replace=(e,t,n)=>{t&&(e+="?"+$.stringify(t)),history.replaceState(t,"",e),window.dispatchEvent(new Event("replaceState")),n||document.documentElement.scrollTo({top:0})},O.back=()=>{history.back()};const N=(e,t)=>{e.showMobileMenu=t,aoife.next(".aoife-markdown-page .mobile-menu")},L=(e,t,n)=>{t.num=n,aoife.next("*"),O.push(e)},z=({state:e,title:t,version:n,data:a})=>aoife("div",{class:"menu"},aoife("div",{class:"menu-title"},t||"Aofie Document"),n&&aoife("div",{class:"menu-version"},n),aoife("div",{class:"menu-items"},a.map(((t,n)=>aoife("div",{class:()=>[e.num===n&&"menu-item-selected","menu-item"],onclick:()=>{L("/"+t.name,e,n)}},t.name)))),aoife("div",{class:"menu-footer",onclick:()=>window.open("https://github.com/ymzuiku/aoife-doc")},"Powered by ",aoife("span",{class:"by-aoife-doc"},"Aoife-doc")));v`
...
`;const P=({title:e,version:t,state:n,markdownState:a,data:r})=>aoife("div",{class:()=>["header js-aoife-markdown-header",a.isScrollDown&&"header-shadow"]},aoife("div",{class:"header-icon",innerHTML:'<svg t="1614770422406" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2063" width="1em" height="1em"><path d="M109.714 292.571h804.572c21.943 0 36.571-21.942 36.571-43.885 0-14.629-14.628-29.257-36.571-29.257H109.714c-21.943 0-36.571 14.628-36.571 36.571 0 14.629 14.628 36.571 36.571 36.571zM914.286 512H109.714c-21.943 0-36.571 14.629-36.571 36.571 0 14.629 14.628 36.572 36.571 36.572h804.572c21.943 0 36.571-21.943 36.571-43.886 0-14.628-14.628-29.257-36.571-29.257z m0 292.571H109.714c-21.943 0-36.571 14.629-36.571 36.572s14.628 36.571 36.571 36.571h804.572c21.943 0 36.571-21.943 36.571-36.571 0-21.943-14.628-36.572-36.571-36.572z" p-id="2064"></path></svg>',onclick:()=>{N(n,!0)}}),aoife("label",{class:"header-title"},e||"Aofie Document"),aoife("div",{class:()=>["mobile-menu",n.showMobileMenu&&"mobile-show"]},aoife("div",{class:"mobile-plan"},aoife(z,{version:t,title:e,data:r,state:n})),aoife("div",{class:"mobile-mask",onclick:()=>{N(n,!1)}})));v`
...
`;const M=()=>aoife("svg",{t:"1614958133927",class:"icon",viewBox:"0 0 1024 1024",version:"1.1",xmlns:"http://www.w3.org/2000/svg","p-id":"4404",width:"1.5em",height:"1.5em"},aoife("path",{d:"M866.92864 476.29312a35.84 35.84 0 1 1 0 71.68h-696.32a35.82976 35.82976 0 0 1-35.84-35.84c0-19.80416 16.03584-35.84 35.84-35.84h696.32z",fill:"currentColor","p-id":"4405"}),aoife("path",{d:"M221.2864 512.13312l213.59616-213.59616a35.84 35.84 0 0 0-50.67776-50.688l-238.9504 238.9504a35.84 35.84 0 0 0 0 50.67776l238.9504 238.9504a35.84 35.84 0 0 0 50.67776-50.688l-213.59616-213.6064z",fill:"currentColor","p-id":"4406"})),U=({state:e,data:t,num:n})=>{const a=n=>{L("/"+t[n].name,e,n)},r=()=>{t[n-1]&&a(n-1)},i=()=>{t[n+1]&&a(n+1)};return n===t.length-1?aoife("div",{class:"aoife-markdown-page-btn"},aoife("div",{class:"btn left",onclick:r},aoife("div",{class:"arrow arrow-left"},aoife(M,null)),aoife("div",{class:"title"},aoife("label",{class:"tip"},"Previous"),aoife("span",{class:"name"},t[n-1].name)))):0===n?aoife("div",{class:"aoife-markdown-page-btn"},aoife("div",{class:"btn right",onclick:i},aoife("div",{class:"title"},aoife("label",{class:"tip"},"Next"),aoife("span",{class:"name"},t[n+1].name)),aoife("div",{class:"arrow arrow-right"},aoife(M,null)))):aoife("div",{class:"aoife-markdown-page-btn double"},aoife("div",{class:"btn left",onclick:r},aoife("div",{class:"arrow arrow-left"},aoife(M,null)),aoife("div",{class:"title"},aoife("label",{class:"tip"},"Previous"),aoife("span",{class:"name"},t[n-1].name))),aoife("div",{class:"btn right",onclick:i},aoife("div",{class:"title"},aoife("label",{class:"tip"},"Next"),aoife("span",{class:"name"},t[n+1].name)),aoife("div",{class:"arrow arrow-right"},aoife(M,null))))};function j(e){const t=function(){if(window.location.hash.length>1){const e=window.location.hash.replace("#/","");return decodeURI(e)}const e=window.location.pathname.replace("/","");return decodeURI(e)}();if(!t)return 0;let n=0;return e.forEach(((e,a)=>{e.name===t&&(n=a)})),n}v`
...
`;const G=({version:e,title:t,data:n})=>{const a={num:j(n),showMobileMenu:!1,showPcMenu:!0};return aoife("div",{class:"aoife-markdown-page"},aoife(P,{version:e,data:n,title:t,state:a,markdownState:S}),aoife("div",{class:"content"},aoife("div",{class:"menu-box"},aoife(z,{version:e,title:t,state:a,data:n})),aoife("div",{class:"aoife-markdown-page-md"},n.map(((e,t)=>aoife(O,{root:0===t,url:"/"+e.name,render:()=>aoife(T,{footer:aoife(U,{state:a,num:t,data:n}),text:n[t]&&n[t].text})}))))))};v`
...
`;const H=({url:t})=>{fetch(t+"?t="+Date.now()).then((e=>e.json())).then((t=>{const a=t.files.map((e=>(/\.md$/.test(e)||(e+=".md"),fetch(t.path+e+"?version="+t.version||"0.0.0").then((e=>e.text())))));Promise.all(a).then((a=>{const r=[];a.forEach(((e,n)=>{r.push({name:t.files[n],text:e})})),n.innerHTML="",t.list=r,n.replaceWith(aoife(G,e({data:r},t)))}))}));const n=aoife("div",{class:"aoife-markdown-loading"},"Loading...");return n};v`
...
`,w(window.aoifeMarkdownTheme||"gitbook"),window.MarkdownBook=H;export{H as M,C as V,s as a,l as b,r as c,i as d,G as e,T as f,o as g,w as u};
