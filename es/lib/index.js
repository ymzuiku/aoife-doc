...
`+r.raw,v.text+=`
`+r.text):t.push(r);continue}if(e){var $="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error($);break}else throw new Error($)}}return t},s.inline=function(e){var t,a,r,o,S,v,$=e.length;for(t=0;t<$;t++)switch(v=e[t],v.type){case"paragraph":case"text":case"heading":{v.tokens=[],this.inlineTokens(v.text,v.tokens);break}case"table":{for(v.tokens={header:[],cells:[]},o=v.header.length,a=0;a<o;a++)v.tokens.header[a]=[],this.inlineTokens(v.header[a],v.tokens.header[a]);for(o=v.cells.length,a=0;a<o;a++)for(S=v.cells[a],v.tokens.cells[a]=[],r=0;r<S.length;r++)v.tokens.cells[a][r]=[],this.inlineTokens(S[r],v.tokens.cells[a][r]);break}case"blockquote":{this.inline(v.tokens);break}case"list":{for(o=v.items.length,a=0;a<o;a++)this.inline(v.items[a].tokens);break}}return e},s.inlineTokens=function(e,t,a,r){t===void 0&&(t=[]),a===void 0&&(a=!1),r===void 0&&(r=!1);var o,S,v=e,$,z,V;if(this.tokens.links){var ne=Object.keys(this.tokens.links);if(ne.length>0)for(;($=this.tokenizer.rules.inline.reflinkSearch.exec(v))!=null;)ne.includes($[0].slice($[0].lastIndexOf("[")+1,-1))&&(v=v.slice(0,$.index)+"["+ye("a",$[0].length-2)+"]"+v.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;($=this.tokenizer.rules.inline.blockSkip.exec(v))!=null;)v=v.slice(0,$.index)+"["+ye("a",$[0].length-2)+"]"+v.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;($=this.tokenizer.rules.inline.escapedEmSt.exec(v))!=null;)v=v.slice(0,$.index)+"++"+v.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex);for(;e;){if(z||(V=""),z=!1,o=this.tokenizer.escape(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.tag(e,a,r)){e=e.substring(o.raw.length),a=o.inLink,r=o.inRawBlock;var K=t[t.length-1];K&&o.type==="text"&&K.type==="text"?(K.raw+=o.raw,K.text+=o.text):t.push(o);continue}if(o=this.tokenizer.link(e)){e=e.substring(o.raw.length),o.type==="link"&&(o.tokens=this.inlineTokens(o.text,[],!0,r)),t.push(o);continue}if(o=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(o.raw.length);var j=t[t.length-1];o.type==="link"?(o.tokens=this.inlineTokens(o.text,[],!0,r),t.push(o)):j&&o.type==="text"&&j.type==="text"?(j.raw+=o.raw,j.text+=o.text):t.push(o);continue}if(o=this.tokenizer.emStrong(e,v,V)){e=e.substring(o.raw.length),o.tokens=this.inlineTokens(o.text,[],a,r),t.push(o);continue}if(o=this.tokenizer.codespan(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.br(e)){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.del(e)){e=e.substring(o.raw.length),o.tokens=this.inlineTokens(o.text,[],a,r),t.push(o);continue}if(o=this.tokenizer.autolink(e,Ee)){e=e.substring(o.raw.length),t.push(o);continue}if(!a&&(o=this.tokenizer.url(e,Ee))){e=e.substring(o.raw.length),t.push(o);continue}if(o=this.tokenizer.inlineText(e,r,X)){e=e.substring(o.raw.length),o.raw.slice(-1)!=="_"&&(V=o.raw.slice(-1)),z=!0,S=t[t.length-1],S&&S.type==="text"?(S.raw+=o.raw,S.text+=o.text):t.push(o);continue}if(e){var be="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(be);break}else throw new Error(be)}}return t},i(c,null,[{key:"rules",get:function(){return{block:fe,inline:De}}}]),c}(),gt=b.defaults,Ve=B.cleanUrl,$e=B.escape,ze=function(){function c(l){this.options=l||gt}var s=c.prototype;return s.code=function(e,t,a){var r=(t||"").match(/\S*/)[0];if(this.options.highlight){var o=this.options.highlight(e,r);o!=null&&o!==e&&(a=!0,e=o)}return e=e.replace(/\n$/,"")+`
...
`;qe(window.aoifeMarkdownTheme||"gitbook");window.MarkdownBook=Ye;export{Re as Markdown,Ye as MarkdownBook,Le as MarkdownPage,Be as render,qe as usePrismTheme};
