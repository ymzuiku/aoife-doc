...
?])[ 	]*(?:<<prop>>[ 	]+)?)<<key>>(?=\\s*:\\s)`.replace(/<<prop>>/g,function(){return d}).replace(/<<key>>/g,function(){return"(?:"+f+"|"+x+")"})),lookbehind:!0,greedy:!0,alias:"atrule"},directive:{pattern:/(^[ \t]*)%.+/m,lookbehind:!0,alias:"important"},datetime:{pattern:b("\\d{4}-\\d\\d?-\\d\\d?(?:[tT]|[ 	]+)\\d\\d?:\\d{2}:\\d{2}(?:\\.\\d*)?(?:[ 	]*(?:Z|[-+]\\d\\d?(?::\\d{2})?))?|\\d{4}-\\d{2}-\\d{2}|\\d\\d?:\\d{2}(?::\\d{2}(?:\\.\\d*)?)?"),lookbehind:!0,alias:"number"},boolean:{pattern:b("true|false","i"),lookbehind:!0,alias:"important"},null:{pattern:b("null|~","i"),lookbehind:!0,alias:"important"},string:{pattern:b(x),lookbehind:!0,greedy:!0},number:{pattern:b("[+-]?(?:0x[\\da-f]+|0o[0-7]+|(?:\\d+(?:\\.\\d*)?|\\.?\\d+)(?:e[+-]?\\d+)?|\\.inf|\\.nan)","i"),lookbehind:!0},tag:u,important:i,punctuation:/---|[:[\]{}\-,|>?]|\.\.\./},n.languages.yml=n.languages.yaml})(h)});var $n=Pe(at());var Ze=Pe(it());var St=Object.create,He=Object.defineProperty,Tt=Object.getPrototypeOf,$t=Object.prototype.hasOwnProperty,_t=Object.getOwnPropertyNames,It=Object.getOwnPropertyDescriptor,Bt=n=>He(n,"__esModule",{value:!0}),Rt=(n,i)=>()=>(i||(i={exports:{}},n(i.exports,i)),i.exports),Ot=(n,i,u)=>{if(i&&typeof i=="object"||typeof i=="function")for(let d of _t(i))!$t.call(n,d)&&d!=="default"&&He(n,d,{get:()=>i[d],enumerable:!(u=It(i,d))||u.enumerable});return n},Nt=n=>n&&n.__esModule?n:Ot(Bt(He(n!=null?St(Tt(n)):{},"default",{value:n,enumerable:!0})),n),zt=Rt((n,i)=>{(function(u,d){typeof n=="object"&&typeof i!="undefined"?i.exports=d():typeof define=="function"&&define.amd?define(d):(u=u||self).templateFn=d()})(n,function(){"use strict";return function(){for(var u=[],d=0;d<arguments.length;d++)u[d]=arguments[d];if(1<u.length){var f=u[0],x=u.slice(1),b="";return f.forEach(function(_,M){b+=_,x[M]&&(b+=x[M])}),b}return typeof u[0]=="string"?u[0]:u[0]?u[0].join(""):""}})}),Lt=Nt(zt()),ot={};function Pt(...n){let i=Lt.default(...n);if(ot[i])return;ot[i]=!0;let u=document.createElement("style");u.innerHTML=i,document.head.append(u)}var ge=Pt;ge`
  :root {
    --vmdb-header: 50px;
    --vmdb-radius: 6px;
    --vmdb-line: #ddeeee;
...
`;var Ae={changeMobileMenuShow:(n,i)=>{n.showMobileMenu=i,aoife.next(".aoife-markdown-page .mobile-menu")},changeUrl:(n,i,u)=>{Ae.changeMobileMenuShow(i,!1),document.documentElement.scrollTo({top:0}),i.num=u,aoife.next("*"),window.history.replaceState(null,"",n)}};var Oe=({state:n,title:i,version:u,data:d})=>aoife("div",{class:"menu"},aoife("div",{class:"menu-title"},i||"Aofie Document"),u&&aoife("div",{class:"menu-version"},u),aoife("div",{class:"menu-items"},d.map((f,x)=>aoife("div",{class:()=>[n.num===x&&"menu-item-selected","menu-item"],onclick:()=>{Ae.changeUrl("/"+f.name,n,x)}},f.name))),aoife("div",{class:"menu-footer",onclick:()=>window.open("https://github.com/ymzuiku/aoife-doc")},"Powered by ",aoife("span",{class:"by-aoife-doc"},"Aoife-doc")));ge`
